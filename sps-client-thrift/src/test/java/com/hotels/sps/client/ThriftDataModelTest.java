...
public class ThriftDataModelTest {
    
    private static final Logger LOG = LoggerFactory.getLogger(ThriftDataModelTest.class);
    private static final DataModel DATA_MODEL = new ThriftDataModel();
